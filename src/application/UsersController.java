...
public class UsersController {
	...
	public void handleMouseClick(Event event){
    	...
    	if (event.getSource() == userPageAnchorPane) {
    		resetDelete();
    	}
    }
	...
	public void deleteUser(ActionEvent event) {
		if (deleteCount == 2) {
			String query = 
					String.format("Delete from users where id = %s", tfID.getText());
			...
			deleteUserBtn.setText("Confirm delete ?");
			deleteCount += 1;
		}
	}
	...
	public void resetDelete() {
		deleteCount = 1;
		deleteUserBtn.setText("Delete Record");
	}
